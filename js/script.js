...
var userAgent = navigator.userAgent.toLowerCase(),
    ...
    plugins = {
      ...
      googleMapLibraries: '//maps.google.com/maps/api/js?key=AIzaSyAFeB0kVA6ouyJ_gEvFbMaefLy3cBCyRwo&sensor=false&libraries=geometry,places&v=3.7',
  ...
  if (plugins.flickrfeed.length > 0) {
    for (i = 0; i < plugins.flickrfeed.length; i++) {
      ...
      $(flickrfeedItem).RDFlickr({
        callback: function () {
          var items = $(flickrfeedItem).find("[data-lightbox='image']");
